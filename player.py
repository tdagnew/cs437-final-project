...
class Player(pygame.sprite.Sprite):
	...
	def checkBounds(self):
		...
		if self.number == 1 and self.x + (self.width / 2) > (self.screen.get_width() / 2) - 2:
			self.x = (self.screen.get_width() / 2) - (self.width / 2) - 2
		elif self.number == 2 and self.x - (self.width / 2) < (self.screen.get_width() / 2) + 2:
			self.x = (self.screen.get_width() / 2) + (self.width / 2) + 2
